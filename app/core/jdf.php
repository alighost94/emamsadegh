<?php
/*------------------------------
Version 2.0 - 1394/09/08
http://jdf.scr.ir
http://jdf.scr.ir/jdf-2-0-php
-------------------------------*/
    ...
    for($i=0; $i<$sl; $i++){
        ...
        switch($sub){
            ...
            case'N':
                ...
                break;
            case'o':
                $jw=($j_y%33%4==1 OR ($j_y%33==0 AND $j_y%4==1))?1:0;
                $out.=($jw==($doy>78 AND $doy<(78+12))?$j_y-1:$j_y);
                break;
            case'O':
                $out.=$date[4];
                break;
            ...
            case'W':
                ...
                if($avs<4){
                    ...
                    $num=($avs==4 OR $avs==(($j_y%33%4==1 OR ($j_y%33==0 AND $j_y%4==1))?5:4))?53:52;
                }
                $aks=$avs+$kab;
                if($aks==7)$aks=0;
    ...
    for($i=0; $i<$sl; $i++){
        ...
        switch($sub){
            ...
            case'r':
                ...
                $out.=$date[1].':'.$date[2].':'.$date[5].' '.$date[5].' '.$key['rh'].'، '.$j_d.' '.$key['mm'].' '.$j_y;
                break;
            case's':
                $out.=$date[5];
                break;
