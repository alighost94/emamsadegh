<?php
// این فایل برای استفاده در تمام View های معلم
        ...
        <div class="p-4 text-center text-white border-bottom">
            ...
            <div class="mt-3">
                <?php if (!empty($profile['profile_image'])): ?>
                    <img src="uploads/teachers/<?php echo $teacher['id']; ?>/<?php echo $profile['profile_image']; ?>" 
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link text-white <?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : ''; ?>" 
                   href="<?php echo BASE_URL; ?>teacher">
                    <i class="bi bi-speedometer2"></i> داشبورد
                </a>
            </li>
            <!-- اضافه کردن این آیتم به منو -->
<li class="nav-item">
    <a class="nav-link text-white <?php echo basename($_SERVER['PHP_SELF']) == 'staff_records.php' ? 'active' : ''; ?>" 
       href="<?php echo BASE_URL; ?>teacher/staffRecords">
        <i class="bi bi-folder"></i> پرونده شخصی
    </a>
</li>
            <li class="nav-item">
                <a class="nav-link text-white <?php echo basename($_SERVER['PHP_SELF']) == 'profile.php' ? 'active' : ''; ?>" 
                   href="<?php echo BASE_URL; ?>teacher/profile">
                    <i class="bi bi-person"></i> پروفایل من
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white <?php echo basename($_SERVER['PHP_SELF']) == 'attendance.php' ? 'active' : ''; ?>" 
                   href="<?php echo BASE_URL; ?>teacher/attendance">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php echo basename($_SERVER['PHP_SELF']) == 'grades.php' ? 'active' : ''; ?>" 
                   href="<?php echo BASE_URL; ?>teacher/grades">
