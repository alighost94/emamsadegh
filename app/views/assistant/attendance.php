            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div class="tab-content" id="attendanceTabsContent">
                    ...
                    <div class="tab-pane fade" id="student" role="tabpanel">
                        <?php 
                        // 🔥 گروه‌بندی داده‌ها بر اساس دانش‌آموز
...
<div class="tab-pane fade" id="stats" role="tabpanel">
    <div class="row">
        <div class="col-lg-6 mb-4">
            <div class="card h-100">
                <div class="card-header bg-light">
                    <h6 class="mb-0"><i class="bi bi-bar-chart"></i> آمار کلی</h6>
                </div>
                <div class="card-body">
                    <!-- 🔥 آمار ساده از داده‌های موجود -->
                    <?php
                    // محاسبه آمار از داده‌های اصلی
                    $stats_by_date = [];
                    foreach ($data['attendance'] as $record) {
        ...
        <div class="col-lg-6 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <!-- 🔥 محاسبه غیبت مکرر از داده‌های موجود -->
                    <?php
                    $absent_students = [];
                    foreach ($data['attendance'] as $record) {
    ...
    <!-- 🔥 اضافه کردن نمودار ساده -->
    <div class="row mt-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-light">
                    <h6 class="mb-0"><i class="bi bi-pie-chart"></i> نمودار وضعیت حضور و غیاب</h6>
                </div>
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-md-3 col-6 mb-3">
                            <div class="bg-success text-white p-3 rounded">
                                ...
                                <small>حاضر (<?php echo $total_records > 0 ? round(($present_count / $total_records) * 100, 1) : 0; ?>%)</small>
                            </div>
                        </div>
                        <div class="col-md-3 col-6 mb-3">
                            <div class="bg-danger text-white p-3 rounded">
                                <h4><?php echo $absent_count; ?></h4>
                                <small>غایب (<?php echo $total_records > 0 ? round(($absent_count / $total_records) * 100, 1) : 0; ?>%)</small>
                            </div>
                        </div>
                        <div class="col-md-3 col-6 mb-3">
                            <div class="bg-warning text-dark p-3 rounded">
                                <h4><?php echo $late_count; ?></h4>
                                <small>تأخیر (<?php echo $total_records > 0 ? round(($late_count / $total_records) * 100, 1) : 0; ?>%)</small>
                            </div>
                        </div>
                        <div class="col-md-3 col-6 mb-3">
                            <div class="bg-secondary text-white p-3 rounded">
                                <h4><?php echo $excused_count; ?></h4>
                                <small>عذردار (<?php echo $total_records > 0 ? round(($excused_count / $total_records) * 100, 1) : 0; ?>%)</small>
                            </div>
                        </div>
                    </div>
                </div>
